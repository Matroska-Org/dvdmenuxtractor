...
CCFLAGS += -DSTDC_HEADERS -DUNUSED="__attribute__((unused))" -I . -I ../win32 -I ..  -I ../../..
CCFLAGS += -mthreads -D__MINGW32__ -D_WIN32 -D_M_IX86 -O3 -fomit-frame-pointer -march=i686 -msse -mmmx
CFLAGS += -Wdeclaration-after-statement
CXXFLAGS +=  -fno-for-scope
ASMFLAGS += -f win32 -D_WIN32 -DSTDC_HEADERS -DUNUSED="__attribute__((unused))" -I../win32 -I..
NASMFLAGS += -f win32 -D_WIN32 -DSTDC_HEADERS -DUNUSED="__attribute__((unused))" -I../win32 -I.. -I ../../..
SFLAGS +=  -DSTDC_HEADERS -DUNUSED="__attribute__((unused))" -I../win32 -I.. -I ../../..
LFLAGS += -static
