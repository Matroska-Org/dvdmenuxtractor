...
#if defined(WIN32) || defined(WIN64) /* replacement gettimeofday implementation */
#include <sys/timeb.h>
...
#if !defined(WIN32) && !defined(WIN64) /* don't have fchdir, and getcwd( NULL, ... ) is strange */
...
ssize_t DVDReadBytes( dvd_file_t *dvd_file, void *data, size_t byte_size )
{
  ...
  dvd_file->seek_pos += (unsigned int)byte_size;
  return byte_size;
}
